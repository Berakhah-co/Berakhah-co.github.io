...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mes = hoy.getMonth(); // getMonth() devuelve 10 para noviembre

    // 2. Comprobar si hoy es 8 de noviembre.
    if (dia === 8 && mes === 10) {
        // 3. Si es la fecha de la promoción, mostrar un mensaje de bienvenida.
        //    MODIFICACIÓN: Se usa la opción 'html' para añadir el texto de T&C.
        Swal.fire({
            title: '¡Promoción Especial de Hoy!',
            html: `¡Hoy, 8 de noviembre, muchos de nuestros productos tienen un precio especial de $37.999!
                   <br>
                   <small style="font-size: 0.8em;"><i>Aplican T&C</i></small>`,
            icon: 'info',
...
// =======================================================================
// === FUNCIÓN MODIFICADA PARA LA PROMOCIÓN CONDICIONAL ===
// =======================================================================
function agregarAlCarrito(nombre, precio) {
    ...
    //    MODIFICACIÓN: Se añade la condición para excluir productos de más de $60.000.
    //    La promoción se aplica solo si es el día correcto Y si el precio original es 60000 o menos.
    const precioFinal = (esDiaDePromocion && parseFloat(precio) <= 60000) ? precioEspecial : precio;
